...
*(That change alone took us from 37% to 44%. It is in `DECISIONS.md` D17 if anyone asks.)*
...
> "Same question. Same memories. Same answer — we check that, byte for byte. **Forty-four
> percent cheaper.**"
...
> conversation took us from 37% to 44%.
